      ...
      <div className="h-auto md:h-[40rem] w-full rounded-md flex flex-col item-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
        ...
        <div className="p-4 relative z-10 w-full text-center">
          ...
          <p className="mt-4 font-normal text-base md:text-xl text-neutral-300 max-w-lg mx-auto">
            Dive into our comprehensive music courses and <br />
            transform your musical journey today. whether you're a biginner or
            looking to refine your skills,join us to unlock your true porential.
          </p>
          <div className="mt-4">
            <Link href={"/courses"}>
